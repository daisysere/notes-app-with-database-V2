...
const AlbumsService_subm_v1 = require('./service/postgres/AlbumsService_subm_v1');
const AlbumsValidator_subm_v1 = require('./validator/albums_subm_v1');

// songs - submission 1
const songs_subm_v1 = require('./api/songs_subm_v1');
const SongsService_subm_v1 = require('./service/postgres/SongsService_subm_v1');
const SongsValidator_subm_v1 = require('./validator/songs_subm_v1');

// users - submission 2
const users_subm_v2 = require('./api/users_subm_v2');
const UsersService_subm_v2 = require('./service/postgres/UsersService_subm_v2');
...
const AuthenticationsService_subm_v2 = require('./service/postgres/AuthenticationsService_subm_v2');
...
const PlaylistsService_subm_v2 = require('./service/postgres/PlaylistsService_subm_v2');
...
const CollaborationsService_subm_v2 = require('./service/postgres/CollaborationsServices_subm_v2');
